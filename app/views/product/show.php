        ...
        <div class="col-md-5">
            <?php if (!empty($product->image)) : ?>
                <img src="<?php echo url($product->image); ?>"
                     ...
                     alt="Ảnh sản phẩm">
            <?php else : ?>
                <div class="p-5 text-center rounded-4 border border-secondary"
                     style="background: rgba(255,255,255,0.06); min-height: 300px;">
        ...
        <div class="col-md-7">
            ...
            <div class="row mt-4">
                <div class="col-md-6 mb-3">
                    <div class="stat-card">
                        <p class="text-white-50 mb-1">Danh mục</p>
                ...
                <div class="col-md-6 mb-3">
                    <div class="stat-card">
                        <p class="text-white-50 mb-1">Giá sản phẩm</p>
