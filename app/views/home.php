            ...
            <div class="col-lg-10">
                <div class="hero-card p-5 text-white">
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                            <span class="badge rounded-pill bg-info text-dark px-4 py-2 mb-4">
                        ...
                        <div class="col-lg-5 mt-5 mt-lg-0">
                            <div class="stat-card mb-3">
                                <h5><i class="bi bi-check-circle text-success"></i> Product CRUD</h5>
                                <p class="text-white-50 mb-0">Thêm, xem, sửa, xóa sản phẩm.</p>
                            </div>

                            <div class="stat-card mb-3">
                                <h5><i class="bi bi-check-circle text-success"></i> Category CRUD</h5>
                                <p class="text-white-50 mb-0">Thêm, sửa, xóa danh mục.</p>
                            </div>

                            <div class="stat-card">
                                <h5><i class="bi bi-check-circle text-success"></i> Upload ảnh</h5>
                                <p class="text-white-50 mb-0">Lưu ảnh vào thư mục public/uploads.</p>
                            </div>
                        </div>
                    </div>
                </div>
